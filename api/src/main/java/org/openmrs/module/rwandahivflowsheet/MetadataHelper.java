...
public class MetadataHelper {
    ...
    public static List<String> setupConstants(){
        ...
        if (props.size() > 0){
            ...
            ConceptDictionary.CBS_ENROLLMENT_DATE   = setup("CBS_ENROLLMENT_DATE", props, unfoundItems);
            ...
            ConceptDictionary.CBS_FINAL_RITA_RECENCY_RESULT = setup("CBS_FINAL_RITA_RECENCY_RESULT", props, unfoundItems);
            
            ConceptDictionary.CBS_FINAL_RITA_INCONCLUSIVE = setup("CBS_FINAL_RITA_INCONCLUSIVE", props, unfoundItems);
            ...
            ConceptDictionary.ADULT_CBS_CONTACT_FORM =setupForm("rwandaadulthivflowsheet.Form_CbsContact");
